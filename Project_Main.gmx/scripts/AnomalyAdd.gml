...
DebugLog("Adding anomaly; "+string(argument0)+" | "+string(argument1)+" | "+string(argument2)+" | "+string(argument3)+" | "+string(argument4)+" | "+string(argument5));
...
DebugLog(string(argument0)+" anomaly added.");
