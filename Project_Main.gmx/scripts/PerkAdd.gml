...
DebugLog("Adding Perk; "+string(argument0)+" | description: "+string(argument1)+" | populationMod: "+string(argument2)+" | productionMod: "+string(argument3)+" | scienceMod: "+string(argument4)+" | powerMod: "+string(argument5));
...
DebugLog("Added "+string(PerkSystem.store[index].name)+" Perk.");
